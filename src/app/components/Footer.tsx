        ...
        <footer>
            <div className="flex flex-col items-center justify-center py-8">
                ...
                <a href="https://github.com/nitrousosint">
                    <svg className="mr-2 h-5 w-5" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<span className="text-sm text-gray-400">Made by Marc & David &#169; 2024</span>
</div>
</div>
</footer>
);
